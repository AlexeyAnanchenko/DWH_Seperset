...
-- Создание таблицы "Информация о продажах"
CREATE TABLE sales_raw (
    order_id SERIAL PRIMARY KEY,
    datetime_of_sale TIMESTAMP,
    product_name VARCHAR(100),
    price_of_sale NUMERIC(10, 2),
    brand_name VARCHAR(50),
    category_name VARCHAR(50),
    promo_id INTEGER,
    customer_cookies VARCHAR(100),
    sum_of_sale NUMERIC(10, 2)
);

-- Создание таблицы "Информация о личных кабинетах покупателей"
...
-- Создание таблицы "Информация о промо-акциях"
...
-- Создаём представление для мнократного использования при заливке CORE-слоя
